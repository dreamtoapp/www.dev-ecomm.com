...
export default function InfiniteProductList({
  ...
  const [products, setProducts] = useState<(Product & { _uniqueKey: string })[]>(initialProductsWithKeys);
  ...
  return (
    <div className="relative">
      <InfiniteScroll
        ...
        endMessage={
          <p className="text-center p-4 text-muted-foreground">
            لقد شاهدت جميع المنتجات المتاحة
          </p>
        }
      ...
      >
        ...
        {error && (
          <div className="text-center p-4 mt-4 bg-red-50 dark:bg-red-900/20 rounded-lg">
