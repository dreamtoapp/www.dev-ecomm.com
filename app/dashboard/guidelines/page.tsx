...
const AdminGuidelinesPage = () => (
  <div className="max-h-screen p-6 bg-background rounded-xl shadow-lg border border-border text-right overflow-y-auto" style={{ maxHeight: '90vh' }} dir="rtl">
    <Card className="mb-6">
      <CardHeader>
      ...
      <CardContent className="space-y-4 text-lg">
        <p>
          مرحباً بك في لوحة تحكم المتجر. هذا الدليل يوضح لك كيفية إدارة المنتجات، العروض، الموردين، والمستخدمين، بالإضافة إلى تعليمات رفع الصور.
        </p>
      </CardContent>
    </Card>
    ...
    <Card className="mb-6">
      ...
      <CardContent className="space-y-2">
        <ul className="list-decimal pr-6 space-y-2">
          <li>يفضل رفع الصور بصيغة <b>WebP</b> لجودة عالية وحجم صغير. إذا لم تتوفر، استخدم <b>JPEG</b> أو <b>PNG</b> للصور التي تحتاج خلفية شفافة.</li>
          <li>حجم الصورة الأقصى المسموح به: <b>2 ميجابايت</b>.</li>
          <li>أبعاد الصور الموصى بها:
            <ul className="list-disc pr-6 mt-2 space-y-1 text-base">
              <li><b>صور المنتجات:</b> 800×800 بكسل (نسبة 1:1)</li>
              <li><b>شعار الشركة:</b> 300×100 بكسل أو SVG</li>
              <li><b>صور الموردين:</b> 200×200 بكسل (مربع)</li>
              <li><b>صور العروض:</b> 1200×630 بكسل (مستطيل)</li>
              <li><b>صور السلايدر (البنر):</b> 1200×600 بكسل (2:1) كحد أدنى، ويفضل 1920×600 أو حتى 1920×800 بكسل لجودة أعلى على الشاشات الكبيرة.</li>
            </ul>
          </li>
