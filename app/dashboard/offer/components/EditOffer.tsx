...
const OfferForm = ({ id, name, logo }: { name: string, logo: string | null, id: string }
  ...
  const [state, addAction, isPending] = useActionState(updateOffer, { success: false, message: "" });
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="sm:max-w-[425px] min-h-[500px] bg-background text-foreground border-border shadow-lg" dir="rtl">
        <DialogHeader>
          <DialogTitle className="text-lg font-semibold text-right">تعديل العرض</DialogTitle>
